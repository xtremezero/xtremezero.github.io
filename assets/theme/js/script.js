...
(function () {
    function b(a, c) { var b = Array.from(a.querySelectorAll(c)); a.matches && a.matches(c) && b.splice(0, 0, a); return b } function h(a) { a = a.getBoundingClientRect(); return { top: a.top + document.body.scrollTop, left: a.left + document.body.scrollLeft } } function d(a) { return parseFloat(getComputedStyle(a, null).height.replace("px", "")) } function q(a) { return parseFloat(getComputedStyle(a, null).width.replace("px", "")) } function l(a) { "loading" != document.readyState ? a() : document.addEventListener("DOMContentLoaded", a) } function p(a) {
    ...
    } function r(a) { a.style.display = "block"; (function e() { var b = parseFloat(a.style.opacity); 1 < (b += .1) || (a.style.opacity = b, requestAnimationFrame(e)) })() } function w(a) {
        var c = [], b = { blackberry: "BlackBerry", android: "Android", windows: "IEMobile", opera: "Opera Mini", ios: "iPhone|iPad|iPod" }; a = "undefined" == typeof a ? "*" : a.toLowerCase(); "*" === a ? c = Object.values(b) : a in b && c.push(b[a]); return !(!c.length || !navigator.userAgent.match(new RegExp(c.join("|"),
            "i")))
        ...
        var c = a.getAttribute("id") + "-carousel", b = a.getAttribute("data-bs-version") && a.getAttribute("data-bs-version").startsWith("5"); null === a.getAttribute("id") && (c = a.classList.value.match(/cid-.*?(?=\s|$)/) + "-carousel"); a.querySelectorAll(".carousel").forEach(function (a) { a.setAttribute("id", c) }); a.querySelector(".carousel-controls") &&
            a.querySelectorAll(".carousel-controls").forEach(function (a) { a.querySelectorAll("a").forEach(function (a) { a.setAttribute("href", "#" + c); b ? a.setAttribute("data-bs-target", "#" + c) : a.setAttribute("data-target", "#" + c) }) }); a.querySelectorAll(".carousel-indicators > li").forEach(function (a) { b ? a.setAttribute("data-bs-target", "#" + c) : a.setAttribute("data-target", "#" + c) }); B(a)
    } function F(a) {
        var c = a.querySelectorAll(".carousel-item").length, b = a.querySelector(".carousel-inner").getAttribute("data-visible"); c < b &&
        ...
        a.querySelectorAll(".carousel-item").forEach(function (a) { for (var c = a, e = 1; e < b; e++) { (c = c.nextElementSibling) || (c = a.parentNode.children[0] === a ? a.nextElementSibling : a.parentNode.children[0]); var k; if (k = c) { var d = 0; do d++; while (k = k.previousElementSibling); k = d } else k = -1; d = c.querySelector(".col-md-12").cloneNode(!0); d.classList.add("cloneditem-" + e); d.classList.add("clonedCol"); d.setAttribute("data-cloned-index", k); a.children[0].appendChild(d) } })
    } function G(a) {
        var b = "", e = a.querySelector("svg linearGradient");
        if (e) { b = []; e = Array.from(e.children); for (var k = 0; k < e.length; k++)b.push('"' + e[k].getAttribute("stop-color") + '"'); b = '"lineargradient": [' + b + "],"; Array.from(a.querySelectorAll("svg")).some(function (a) { return a.classList.contains("svg-gradient") }) || a.querySelectorAll("svg").forEach(function (a) { a.classList.add("svg-gradient") }) } return b
    } function z(a, b, e) {
        var c = a.closest(".card"), f = c.parentElement.classList; c.getAttribute("style") || c.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;"); f.contains("row") &&
            (f.remove("row"), f.add("media-container-row")); a.querySelectorAll(".svg-gradient > *").forEach(function (a) { a.setAttribute("id", b) }); c = a.cloneNode(!0); Array.from(a.children).forEach(function (a) { if ("SVG" !== a.tagName) return a.remove() }); a.setAttribute("data-pie", "{ " + G(a.closest("section")) + ' "percent": ' + e + ', "size": 150, "colorCircle": "#f1f1f1", "stroke": 5, "colorSlice": "url(#' + b + ')", "fontSize": "1.3rem", "number": false }'); Array.from(c.children).forEach(function (b) {
                switch (!0) {
                    case b.matches("p"): b.innerText =
                        e + "%"; a.appendChild(b); break; case b.matches("svg"): break; default: a.appendChild(b)
                }
            })
    } function D(a) { var b = a.closest("section").getAttribute("id") + "-svg-gradient", e = +a.getAttribute("data-goal"); z(a, b, e) } function H(a, b) {
        if (a.classList.contains("circle-progress-section") && b.includes("progress") && "progressCount" != b) if (b.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function (b) { var c = a.getAttribute("id") + "-svg-gradient", f = +b.getAttribute("data-goal"); z(b, c, f) }); else {
        ...
        } var b = this, e = b.previousElementSibling, d = !!document.documentMode; a(); window.addEventListener("resize", function () { a() }); window.addEventListener("load", function () { a() }); return b
    }; (function (a) {
        var b = function (a, b, c) {
            var f; return function () {
                var e = this, d = arguments; f ?
                    clearTimeout(f) : c && a.apply(e, d); f = setTimeout(function () { c || a.apply(e, d); f = null }, b || 100)
            }
        }; window[a] = function (c) { var d = new CustomEvent(a); return c ? this.addEventListener("resize", b(c)) : this.dispatchEvent(d) }
    })("smartresize"); var I = function () {
        var a = document.createElement("div"), b = document.querySelector("body"); a.setAttribute("style", "height: 50vh; position: absolute; top: -1000px; left: -1000px;"); b.appendChild(a); var d = parseInt(window.innerHeight / 2, 10), k = parseInt((window.getComputedStyle ? getComputedStyle(a,
            null) : a.currentStyle).height, 10); b.removeChild(a); return k == d
    }(); l(function () {
        function a(a) { a.style.height = 9 * q(a.parentNode) / 16 + "px" } function c(a) { setTimeout(function () { b(a, ".mbr-parallax-background").forEach(function (a) { jarallax && (jarallax(a, { speed: .6 }), a.style.position = "relative") }) }, 0) } function e(a) {
            b(a, "[data-bg-video]").forEach(function (a) {
                var b = a.getAttribute("data-bg-video"); if (b) {
                    ...
                    f = a.querySelector(".mbr-background-video-preview") || document.createElement("div"); f.classList.add("mbr-background-video-preview"); f.style.display = "none"; f.style.backgroundSize = "cover"; f.style.backgroundPosition = "center"; a.querySelector(".mbr-background-video-preview") || a.childNodes[0].before(f); if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3]))) if (c && /youtu\.?be/g.test(c[3])) {
                        b = "http" + ("https:" === location.protocol ? "s" : "") + ":"; b += "//img.youtube.com/vi/" + c[6] + "/maxresdefault.jpg"; var d = new Image;
                        d.onload = function () {
                            if (120 === (d.naturalWidth || d.width)) { var b = d.src.split("/").pop(); switch (b) { case "maxresdefault.jpg": d.src = d.src.replace(b, "sddefault.jpg"); break; case "sddefault.jpg": d.src = d.src.replace(b, "hqdefault.jpg"); break; default: m && (f.style.backgroundImage = 'url("images/no-video.jpg")', f.style.display = "block") } } else f.style.backgroundImage = 'url("' + d.src + '")', f.style.display = "block"; a.querySelector(".mbr-background-video") && a.querySelector(".mbr-background-video").remove(); a.querySelector(".mbr-background-video-wrapper") &&
                                ...
                                }); e.style.overflow = "hidden"; e.style.position = "absolute"; e.style.minWidth = "100%"; e.style.minHeight = "100%"; e.style.top = "0"; e.style.left = "0"; e.style.transitionProperty = "opacity"; e.style.transitionDuration = "1000ms"; b.style.marginTop = "0"; b.style.maxWidth = "initial"; b.style.transitionProperty = "opacity"; b.style.transitionDuration = "1000ms"; b.style.pointerEvents = "none"; b.style.position = "absolute"; b.style.top = "0"; b.style.left = "0"; b.style.display = "none";
                            b.style.transform = "scale(1.2)"; u.load(c[6], !0); u.play(); u.mute(); u.on("playing", function () { u.replayFrom(1); u._ready && 0 <= u.getCurrentTime() && (u._player.h.style.display = "block") }); m && t && (g(document).on("delete.cards", function (a) { u.stopResize(); u.stopReplay(a.target.querySelector(".mbr-background-video-wrapper")) }), g(document).on("changeParameter.cards", function (a, b, c, f) {
                                a = a.target.querySelector(".mbr-background-video-wrapper"); if ("bg" === b) switch (f) {
                                    case "type": "video" !== c.type && u.stopReplay(a); break;
                                    case "value": "video" === c.type && u.stopReplay(a)
                                }
                            }))
                        ...
                        if (c && /vimeo/g.test(c[3])) {
                            ...
                            e = null; a.querySelector(".mbr-background-video") && a.querySelector(".mbr-background-video").remove(); e = document.createElement("div"); e.classList.add("mbr-background-video"); a.childNodes[1].before(e); b = new Vimeo.Player(e, { id: b, loop: !0, background: !0, responsive: !0, autoplay: !0, byline: !1, title: !1, muted: !0, controls: !1 }); e = b.element.parentNode; e.style.overflow = "hidden"; b.element.style.pointerEvents = "none"; b.element.style.marginLeft = "-" + (b.element.scrollWidth - e.scrollWidth) / 2 + "px"; b.element.style.minHeight =
                                "100vh"; b.element.style.minWidth = "177.77vh"
                        }
            ...
            function (a, b) { var c = [a, a]; c[b > a ? 0 : 1] = b; window.smartresize(function () { var a = window.innerHeight; 0 > c.indexOf(a) && (a = c[window.innerWidth > a ? 1 : 0]); document.querySelector(".mbr-section--full-height").style.height = a + "px" }) }(window.innerWidth, window.innerHeight) : I || (window.smartresize(function () { document.querySelector(".mbr-section--full-height").style.height = window.innerHeight + "px" }), g(document).on("add.cards", function (a) {
                ...
                window.addEventListener("update.parallax",
                    function (a) { setTimeout(function () { if (a) { var a = document.querySelector(".mbr-parallax-background"); a.jarallax("coverImage"); a.jarallax("clipContainer"); a.jarallax("onScroll") } }, 0) }); if (m) {
                        if (!t) return; g(document).on("add.cards", function (a) { c(a.target); g(window).trigger("update.parallax") }); g(document).on("changeParameter.cards", function (a, b, f, e) {
            ...
            } var k, f, C = 0, n = null, l = !w(); window.addEventListener("scroll", function () {
                f && clearTimeout(f); var a = document.documentElement.scrollTop, b = a <= C || l; C = a; if (n) {
                    var c = a > n.breakPoint;
                    b ? c != n.fixed && (l ? (n.fixed = c, n.elm.classList.toggle("is-fixed")) : f = setTimeout(function () { n.fixed = c; n.elm.classList.toggle("is-fixed") }, 40)) : (n.fixed = !1, n.elm.classList.remove("is-fixed"))
                }
            }); if (t) g(document).on("add.cards delete.cards", function (a) { k && clearTimeout(k); k = setTimeout(function () { n && (n.fixed = !1, n.elm.classList.remove("is-fixed")); var a = document.querySelector(".mbr-fixed-top"); a && (n = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }, a.dispatchEvent(new CustomEvent("scroll"))) }, 650) }); window.smartresize(function () {
            ...
            }); if (t) g(document).on("add.cards", function (a) { document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, "iframe").length && window.dispatchEvent(new CustomEvent("resize")) }); if (m) { if (!t) return; g(document).on("add.cards drag.cards", function (a) { e(a.target) }) } else e(document.body); if (m) g(document).on("changeParameter.cards", function (a, b, c, f) {
                if ("bg" === b) switch (f) {
                    case "type": "video" ===
                        c.type && e(a.target); break; case "value": "video" === c.type && e(a.target)
                }
                    ...
                    var b = a.target; if (!b.parents().some(function (a) { a.classList.contains("carousel") })) {
                        do if (b.hash) {
                            var c = /#bottom|#top/g.test(b.hash); document.querySelector(c ? "body" : b.hash).forEach(function (c) {
                                a.preventDefault(); var f =
                                    b.parents().some(function (a) { return a.classList.contains("navbar-fixed-top") }) ? 60 : 0; f = "#bottom" == b.hash ? d(c) - window.innerHeight : h(c).top - f; c.classList.contains("panel-collapse") || c.classList.contains("tab-pane") || window.scrollTo({ top: f, left: 0, behavior: "smooth" })
                            }); break
        ...
        }); Array.from(document.body.children).filter(function (a) { return !a.matches("style, script") }).forEach(function (a) { a.classList.contains("mbr-reveal") && a.addEventListener("add.cards", function () { a.footerReveal() }) }); l(function () {
            if (w()) {
                var a = this.querySelectorAll("section[data-bg-video]");[].forEach.call(a, function (a) {
                    if (a.querySelector("[video-to-image-on-mobile]")) {
                        var b =
                            a.querySelector("[video-to-image-on-mobile]").getAttribute("video-to-image-on-mobile"); console.log(a.firstChild); if (b) { var c = document.createElement("div"); c.classList.add("mbr-background-video-on-mobile"); c.style.position = "absolute"; c.style.top = "0"; c.style.bottom = "0"; c.style.left = "0"; c.style.right = "0"; c.style.backgroundSize = "cover"; c.style.backgroundPosition = "center center"; c.style.backgroundImage = "url(" + b + ")"; a.insertBefore(c, a.firstChild) }
                    }
                })
            } else if (document.querySelectorAll("input[name=animation]").length) {
                a =
                function () {
                    var a = document.documentElement.scrollTop || document.body.scrollTop, c = a + window.innerHeight - 100; d.forEach(function (f) {
                        var d = f.offsetHeight, k = e(f); (k + d >= a && k - 50 <= c || b(f)) && f.classList.contains("hidden") && (f.classList.remove("hidden"), f.classList.add("animate__fadeInUp"), f.classList.add("animate__delay-1s"), f.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () { f.classList.remove("animate__animated animate__delay-1s animate__fadeInUp") },
                            { once: !0 }))
                    })
                }; var b = function (a) {
                    if (a.parents(".carousel-item").some(function (a) { return "none" !== getComputedStyle(a, null).display })) return !1; var b = a.parents(".carousel-item").parentNode; if (!b || b.querySelectorAll(".carousel-item.active .hidden.animate__animated").length) return !1; if (1 < b.getAttribute("data-visible")) {
                        var c = b.getAttribute("data-visible"); if (a.parents().some(function (a) { return a.matches(".cloneditem-" + (c - 1)) }) && a.parents(".cloneditem-" + (c - 1)).some(function (a) {
                            return a.getAttribute("data-cloned-index") >=
                                c
                        })) return !0; a.classList.remove("animate__animated animate__delay-1s hidden"); return !1
                    } return !0
    ...
    } l(function () { if (document.querySelectorAll(".mbr-arrow-up").length) { var a = document.querySelector("#scrollToTop"); a.style.display = "none"; window.addEventListener("scroll", function () { window.scrollY > window.innerHeight ? r(a) : p(a) }); a.addEventListener("click", function () { window.scrollTo({ top: 0, left: 0, behavior: "smooth" }); return !1 }) } }); if (!m) {
        var v = document.querySelector(".mbr-arrow"); v &&
            v.addEventListener("click", function (a) { a = a.target.closest("section").nextElementSibling; a.classList.contains("engine") && (a = a.closest("section").nextElementSibling); window.scrollTo(0, h(a).top) })
        ...
        function (a) {
            ...
            if (!m) {
                var a = function (a) { b(a.target) }, b = function (b) {
                    var c = b.parents("section")[0].querySelector("iframe"), d = c.getAttribute("src"); b.parents("section").forEach(function (a) { a.style.zIndex = "5000" }); -1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"); if (-1 !== d.indexOf("vimeo")) { var e = new Vimeo.Player(c); e.play() } var g = b.parents("section")[0],
                        h = g.querySelector(g.querySelector("[data-modal]").getAttribute("data-modal")); h.style.display = "table"; h.addEventListener("click", function () { -1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"); -1 !== d.indexOf("vimeo") && e.pause(); h.style.display = "none"; h.removeEventListener("click", a); g.style.zIndex = "0" })
            ...
            var A = document.querySelectorAll(".dropdown-menu.show, .dropdown.open"), J = document.querySelectorAll(".dropdown.open"); v.forEach(function (a) { a.classList.remove("show"); a.ariaExpanded = "false" }); A.forEach(function (a) { return a.classList.remove("show") }); J.forEach(function (a) { return a.classList.remove("open") }); !w() && (v = document.querySelector("section.menu")) && (A = window.innerWidth, !v.querySelector(".navbar").classList.contains("collapsed") && 991 < A && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function (a) {
                a.addEventListener("mouseover",
                    function () { a.classList.contains("open") || a.querySelector("a").dispatchEvent(new Event("click")) }); a.addEventListener("mouseout", function () { a.classList.contains("open") && a.querySelector("a").dispatchEvent(new Event("click")) })
            }), v.querySelectorAll("ul.navbar-nav li.dropdown .dropdown-menu .dropdown").forEach(function (a) {
                a.addEventListener("mouseover", function () { a.classList.contains("open") || (a.querySelector("a").dispatchEvent(new Event("click")), a.classList.add("open")) }); a.addEventListener("mouseout",
                    function () { a.classList.contains("open") && (a.querySelector("a").dispatchEvent(new Event("click")), a.classList.remove("open")) })
            })))
            ...
            !0, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function (a) { a.classList.add("popup-btn") })), "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function (a) { y(a) })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, l(function () {
                ...
                var b = a.querySelectorAll(".carousel-control"), d = a.querySelectorAll(".carousel-indicators li"), h = function (a) { a.stopPropagation(); a.preventDefault() }; a.addEventListener("slide.bs.carousel", function () {
                    b.forEach(function (a) { a.addEventListener("click", h) }); d.forEach(function (a) {
